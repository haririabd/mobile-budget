...
# command to change project name.
# https://stackoverflow.com/questions/18293875/is-there-an-easy-way-to-rename-a-django-project
...
class Command(BaseCommand):
    help = 'Renames the Project: python manage.py renameproject oldname newname'
